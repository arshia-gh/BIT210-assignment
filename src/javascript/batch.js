import main, { attachLogoutListener, fillUserData, toggleLogout } from './main';
...
const getModalVaccinationID = (_) =>
	manageVaccinationModal.getAttribute('data-vaccinationID');
...
manageVaccinationForm.onsubmit = (e) => {
	...
	const vaccination = vaccinations.find(
		(vaccination) => vaccination.vaccinationID === getModalVaccinationID()
	);
...
function renderVaccinationTable(info) {
	//this methods render vaccinations table to UI
	renderTable(
		'tableContainer',
		info,
		'vaccinationID',
